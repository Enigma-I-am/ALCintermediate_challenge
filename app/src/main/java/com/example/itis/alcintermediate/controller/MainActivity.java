...
import com.example.itis.alcintermediate.ItemAdapter;
import com.example.itis.alcintermediate.R;
import com.example.itis.alcintermediate.api.Client;
import com.example.itis.alcintermediate.api.Service;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initViews(){
        ...
        pd.setMessage("getting Github users...");
        ...
        try{
            ...
            call.enqueue(new Callback<ItemResponse>() {
                ...
                public void onFailure(Call<ItemResponse> call, Throwable t) {
                    ...
                    Toast.makeText(MainActivity.this,"Error doing the thing",Toast.LENGTH_SHORT).show();
